...
<body class="d-flex flex-column">
    <div class="flex-grow-1" style="min-height: 100vh;">
        <div class="container-fluid">
            <div class="row">
                <div class="d-none d-md-block col-md-3 bg-info vh-100">
                    <div class="mt-3 d-flex justify-content-start flex-column">
                        <h2 class="navword text-uppercase">Collection</h2>
                        <div class="mt-3">
                            <h5 class="text-uppercase navword">Games</h5>
                            <ul>
                ...
                <div class="d-md-block col-md-9 bg-warning">
                    <div class="mt-3">
